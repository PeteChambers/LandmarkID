...
Landmark ID is a photo recongnition app that uses the Google Cloud Vision API to determine the landmarks present in a users photo.  Users are able to take upload a photo from their photo library or take a photo using the app's built in camea Landmark ID will do the rest.

- Detect landmarks in your photo using photo recognition technology
- Automatic saving of landmarks directly to the app
- View up to date information about the landmark inluding name, location, history and more
